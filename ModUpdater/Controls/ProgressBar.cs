...
namespace ModUpdater.Controls
{
	/// <summary>
	/// A replacement for the default ProgressBar control.
    /// 
    /// This code was taken from http://www.codeproject.com/Articles/19309/Vista-Style-Progress-Bar-in-C.
    /// Licensed under The Code Project Open License (CPOL) 1.02 found at http://www.codeproject.com/info/cpol10.aspx.
    /// I claim no ownership of this file.
    /// 
    /// This code was modified to fix bugs and extend functionality.
	/// </summary>
	...
	public class ProgressBar : System.Windows.Forms.UserControl 
	{
		...
		#region -  Properties  -
			...
			#region -  Value  -
                ...
                private int mStep;
                /// <summary>
                /// The amount to increment the current value of the control by when the PerformStep() method is called.
                /// </summary>
                [Category("Behavior"),
                DefaultValue(10),
                ...
                public int Step
                {
                    ...
                    {
                        mStep = value;
                        StepChangeHandler sc = StepChanged;
                        if (sc != null) { sc(this, new System.EventArgs()); }
                    }
                }
			#endregion
		...
		#region -  Events  -
            ...
            /// <summary>
            /// When the Step property is changed.
            /// </summary>
            public delegate void StepChangeHandler(object sender, EventArgs e);
            /// <summary>
            /// When the Step property is changed.
            /// </summary>
            public event StepChangeHandler StepChanged;
		#endregion
